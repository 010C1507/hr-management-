...
- **สรรหาบุคลากร** — tracking ผู้สมัครตามขั้นตอนการสรรหา 7 ขั้น (รับเรื่อง → คัดกรอง → สัมภาษณ์ → อนุมัติ → เสนอค่าตอบแทน → เซ็นสัญญา → เข้างาน) พร้อมวันเริ่ม-จบ/จำนวนวันอัตโนมัติ, แจ้งเตือนเกิน SLA, funnel รายขั้นตอน, Time to Hire เฉลี่ย และปุ่มเลื่อนขั้นตอน/บันทึกผล
- **รับพนักงานใหม่** — ไทม์ไลน์ onboarding รายสัปดาห์แบบ Gantt
